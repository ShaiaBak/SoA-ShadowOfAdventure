...
namespace QuestSystem {
    public class CollectionObjective : IQuestObjective {
        ...
        private int collectionAmount;   //total amount of what quest needs
        private int currentAmount;      //start at 0
        private GameObject itemToCollect;

        // collect 10 feathers
        /// <summary>
        /// This constructor buils a collection objective.
        /// </summary>
        ...
        public void CheckProgress() {
            // if you collect everything required, complete quest
